...
import { LayoutDashboard, Users, PlusCircle, IndianRupee, CalendarDays, QrCode } from "lucide-react";
import {
  MagnifyingGlassIcon,
...
export default function Home() {
  ...
  const navItems = [
    ...
    { id: "scan-to-pay", label: "Scan to Pay", icon: QrCode, onClick: () => setActiveView("scan-to-pay") },
  ];
